...
var onGetGameData = function onGetGameData(event) {
  ...
  api.getGameData().then(ui.gamesPlayedSuccess);
};

var onUpdateGameBoard = function onUpdateGameBoard(event) {
  api.updateGameBoard();
};

var onOptions = function onOptions(event) {
  event.preventDefault();
  ui.options();
};
...
var onNewGame = function onNewGame(event) {
  event.preventDefault();
  api.newGame().then(ui.onNewGameSuccess);
};
...
var onResumeGame = function onResumeGame(event) {
  ...
  var id = data.id;
  api.resumeGame(id).then(ui.resumeGameSuccess).catch(ui.resumeGameFail);
};
...
module.exports = {
  ...
  onUpdateGameBoard: onUpdateGameBoard
};
...
if (window.location.hostname === 'localhost') {
  apiUrl = 'https://tic-tac-toe-wdi.herokuapp.com';
} else {
  apiUrl = 'https://aqueous-atoll-85096.herokuapp.com';
}
...
var gameUpdates = __webpack_require__(2);
...
var updateBoardApi = __webpack_require__(2);
...
var click = function click(event) {
  ...
  if (store.board[boxId] === '' && store.winner < 0) {
    ...
    switchActivePlayer();
  } else if (store.winner > -1) {} else {
    $('#warning-board').html('Invalid Selection');
  }
};

var updateBoardArray = function updateBoardArray(boxId) {
  var currentPlayerValue = void 0;
...
var checkForWinner = function checkForWinner(boardArr) {
  if (parseInt(boardArr[0], 10) + parseInt(boardArr[1], 10) + parseInt(boardArr[2], 10) === 3 || parseInt(boardArr[3], 10) + parseInt(boardArr[4], 10) + parseInt(boardArr[5], 10) === 3 || parseInt(boardArr[6], 10) + parseInt(boardArr[7], 10) + parseInt(boardArr[8], 10) === 3 || parseInt(boardArr[0], 10) + parseInt(boardArr[3], 10) + parseInt(boardArr[6], 10) === 3 || parseInt(boardArr[1], 10) + parseInt(boardArr[4], 10) + parseInt(boardArr[7], 10) === 3 || parseInt(boardArr[2], 10) + parseInt(boardArr[5], 10) + parseInt(boardArr[8], 10) === 3 || parseInt(boardArr[0], 10) + parseInt(boardArr[4], 10) + parseInt(boardArr[8], 10) === 3 || parseInt(boardArr[6], 10) + parseInt(boardArr[4], 10) + parseInt(boardArr[2], 10) === 3) {
    $('#warning-board').empty();
    $('#message-board').empty();
    $('#game-over').html('Player 1 Wins!');
    store.winner = 0;
  } else if (parseInt(boardArr[0], 10) + parseInt(boardArr[1], 10) + parseInt(boardArr[2], 10) === 12 || parseInt(boardArr[3], 10) + parseInt(boardArr[4], 10) + parseInt(boardArr[5], 10) === 12 || parseInt(boardArr[6], 10) + parseInt(boardArr[7], 10) + parseInt(boardArr[8], 10) === 12 || parseInt(boardArr[0], 10) + parseInt(boardArr[3], 10) + parseInt(boardArr[6], 10) === 12 || parseInt(boardArr[1], 10) + parseInt(boardArr[4], 10) + parseInt(boardArr[7], 10) === 12 || parseInt(boardArr[2], 10) + parseInt(boardArr[5], 10) + parseInt(boardArr[8], 10) === 12 || parseInt(boardArr[0], 10) + parseInt(boardArr[4], 10) + parseInt(boardArr[8], 10) === 12 || parseInt(boardArr[6], 10) + parseInt(boardArr[4], 10) + parseInt(boardArr[2], 10) === 12) {
    $('#warning-board').empty();
    $('#message-board').empty();
...
var onClick = function onClick(boxId, currentPlayer) {
  if (currentPlayer == 0) {
    $('#' + boxId).html('X');
  } else {
    $('#' + boxId).html('O');
...
var updateGameBoard = function updateGameBoard(event) {
  return $.ajax({
...
var resumeGame = function resumeGame(id) {
  return $.ajax({
...
var resumeGameSuccess = function resumeGameSuccess(data) {
...
var resumeGameFail = function resumeGameFail() {
  $('#resume-game input[name="id"]').val('');
...
var restoreGameBoard = function restoreGameBoard(boardArr) {
  var i = -1;
...
var whoseTurn = function whoseTurn(boardArr) {
...
module.exports = {
  ...
  resumeGameSuccess: resumeGameSuccess,
  options: options,
  back: back,
  resumeGameFail: resumeGameFail
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var onSignInModal = function onSignInModal(event) {
  event.preventDefault();
  ui.signInModalSuccess();
};

var onSignUpModal = function onSignUpModal(event) {
  event.preventDefault();
  ui.signUpModalSuccess();
};

var onBackModal = function onBackModal(event) {
  event.preventDefault();
...
var signInUp = function signInUp(data) {
  var uData = store.userData;
  return $.ajax({
...
var signUpInDelete = function signUpInDelete() {
...
var signInModalSuccess = function signInModalSuccess() {
  $('#modal-signIn').removeClass('hide');
  $('.greyout').removeClass('hide');
  $('#sign-up-in').addClass('hide');
};

var signUpModalSuccess = function signUpModalSuccess() {
...
var onBackModalSuccess = function onBackModalSuccess() {
  $('#sign-in input[name="credentials[password]"]').val('');
  $('#sign-in input[name="credentials[email]"]').val('');
  $('#sign-up input[name="credentials[password]"]').val('');
  $('#sign-up input[name="credentials[email]"]').val('');
...
module.exports = {
  ...
  signInModalSuccess: signInModalSuccess,
  signUpModalSuccess: signUpModalSuccess,
  onBackModalSuccess: onBackModalSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = __webpack_require__.p + "633a48471276cff6c56579e371117126.jpg";
